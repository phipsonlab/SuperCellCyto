...
We use a subsampled Levine_32dim dataset stored in a csv file to 
...
```{r plot_marker_expression_supercells}
plotExpression(
...
```{r transfer_cluster_to_singlecell}
...
```{r plot_marker_expression_singlecell}
plotExpression(
